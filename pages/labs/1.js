      ...
      <div className={styles.midrow}>
        <div className={styles.col}>
          ...
          <h3>
            ...
            mass, and ramp length were kept constant, time was measured, and
            gravity was calculated. In the second test, the tennis balls' mass
            and drop height were kept constant, the time to drop was measured,
            and gravity was calculated. In the third test, the pendulum string
            ...
            in the respective experiment. This result was useful as it confirmed
            the value of gravity normally used in experiments.
          </h3>
        </div>
